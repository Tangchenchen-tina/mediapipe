...
http_archive(
    ...
    patches = [
        ...
        # Works around a bzlmod canonical-name bug in tflite_combine_cc_tests
        # (tensorflow/lite/build_def.bzl) that duplicates //:link_extra_lib
        # in generated test targets under a single_version_override'd rules_cc.
